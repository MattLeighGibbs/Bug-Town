...
if (mouse_check_button_pressed(mb_left))
{
	...
	if (hovermode == HoverType.PLACEOBJECT)
	{
	...
	else if (hovermode == HoverType.HOEING)
	{
		var l = layer_get_id("Tiles_1");
		tilemap_set(layer_tilemap_get_id(l), hovered_tile_x, hovered_tile_y, 1); // Assuming 1 is the index of the black tile
	}
}
